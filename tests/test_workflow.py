...
def test_organic_solvents_exclude_the_reference():
    with patch("taster.workflow.prepare_partition_setup", return_value="MOL"), \
         ...
         patch("taster.workflow.process_partition") as mock_process:
        run_partition_workflow("mol.itp", "mol.gro",
